...
1. **Open the Script**: Navigate to the GEE code editor and open the `[GEE_Download_Sentinel2.js](https://github.com/MohammadrezaNarimaniUCDavis/GEE_Download_Sentinel2/blob/main/GEE_Download_Sentinel2.js)` script.
